...
### v1.0.0
* 初始版本发布
* 视野测试: 基础视野测试，类似HFA机器测试流程，测试是否存在视野缺损情况
* 原创模式: 参考测试，基于过去的测试结果，检测当前视野对比过去测试的变化
* 结果分析: 提供敏感度数值图与灰度图，帮助用户理解测试结果。
* 用户档案管理，历史测试记录回溯等功能。

### v1.1.0
* 扩展用户仪表盘和自定义功能, 例如界面颜色选择
* 更优雅的代码结构
* 视野检测：优化测试过程 (更好的抗干扰)
* 多语言支持，当前支持中文与英文

### v1.2.0
* 测试记录管理: 更加完善的测试记录管理功能。支持分类浏览与记录标记。
* 变色阿姆斯勒方格表：原创新功能，实现一个大小，颜色可自定义的方格表，并且可画出扭曲、模糊等视野问题，方便直观反映视野情况。
...
## 📖 使用指南 (Usage)
* 视频教程: [LuminaTracer-家庭视野测试程序](https://www.bilibili.com/video/BV1bLoDBeEWr)

运行 **Lumina Tracer** 后，会进入登录/注册页面。
注册：第一次使用可以随便注册喜欢的账号密码，并没有检测机制。账号需以邮箱形式。

### 1. 运行流程 (视野测试功能, v1.0.0+):
为了获得相对准确的参考结果，请遵守以下物理环境要求：
* 环境准备:
保持室内光线昏暗，确保屏幕无反光。
保持眼睛与屏幕的距离，差不多让视野覆盖屏幕的短边。
测试左眼时请遮盖右眼，反之亦然。
...
### 2. 运行流程 (可编辑变色方格表, v1.2.0+):
* 选择参数: 进入方格表功能模块，选择所需颜色与表格大小
* 图像编辑: 在方格表上编辑对应的扭曲、模糊等视野问题。

### 功能示例
* 视频教程: [LuminaTracer-家庭视野测试程序](https://www.bilibili.com/video/BV1bLoDBeEWr)
* v1.2.0 - 变色阿姆斯勒方格表 + 测试记录管理功能

| 方格表编辑 | 方格表设置 | 报告管理 |
|---------|---------|---------|
| ![方格表编辑](image/v1.2.0/grid_report.jpg) | ![方格表设置](image/v1.2.0/grid_setup.jpg) | ![报告管理](image/v1.2.0/report_manange.jpg) |

* v1.1.0 - 扩展仪表盘以及多语言支持

| 用户界面 | 设置界面 |
|---------|---------|
| ![用户界面](image/v1.1.0/user_screen.png) | ![设置界面](image/v1.1.0/setting.png) |

* v1.0.0 - 注册登录与视野测试

| 注册/登录 | 准备测试 | 测试与报告 |
|---------|---------|-----------|
| ![注册](image/v1.0.0/signup.jpg) | ![准备](image/v1.0.0/prepare.jpg) | ![测试中](image/v1.0.0/testing.jpg) |
| ![登录](image/v1.0.0/signin.jpg) | ![开始测试](image/v1.0.0/start_test.jpg) | ![报告](image/v1.0.0/report.jpg) |
